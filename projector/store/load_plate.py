...
dataset_base_path = os.path.expanduser("/local/gauri/spring18/me592x/mlproject")
...
def load_pickle(pickle_path, dataset_path):
    if not os.path.exists(pickle_path):
        ...
        for dir, _, _, in os.walk(dataset_path):
            filenames = glob.glob( os.path.join(dir, '*.png'))  # may be JPEG, depending on your image files
            print filenames
...
def load_image( path, pre_height=136, pre_width=136, height=106, width=106 ):
